...
import 'package:chat_app_test/application/message/message_cubit.dart';
          ...
          builder: (context, state) {
            return state.maybeMap(
              ...
              onMessages: (value) {
                ...
                final currUser = room.users.firstWhere(
                  (element) => element.id == currUserId,
                  orElse: () =>
                      const type.User(id: '', firstName: 'Unknown User'),
                );
